...
public class FormFuncionario extends javax.swing.JDialog {
    ...
    public FormFuncionario(java.awt.Frame parent, boolean modal) {
        ...
        trataEdicao(false);
        listCidade.clear();
        listCidade.addAll(objCidadeDAO.getLista());
    }
    
    public void atulizaTabela(){
        listFuncionario.clear();
        listFuncionario.addAll(objFuncionarioDAO.getLista());
        int linha = listFuncionario.size() - 1;
        if(linha >= 0){
            tbl_funcionario.setRowSelectionInterval(linha, linha);
            tbl_funcionario.scrollRectToVisible(tbl_funcionario.getCellRect(linha, linha, true));
        }
    }
    ...
    private void trataEdicao(boolean editando){
        ...
        cbx_cidade.setEnabled(editando);
        tbl_funcionario.setEnabled(editando);
    }
    ...
    public boolean validaCampos(){
        ...
        if(!(cbx_cidade.getSelectedIndex() >= 0)){
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listFuncionario, tbl_funcionario);
        ...
        if (tbl_funcionario.getColumnModel().getColumnCount() > 0) {
            tbl_funcionario.getColumnModel().getColumn(0).setResizable(false);
            tbl_funcionario.getColumnModel().getColumn(2).setResizable(false);
        }
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tbl_funcionario, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.codigoFuncionario}"), input_codigo, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tbl_funcionario, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nomeFuncionario}"), input_cidade, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        org.jdesktop.swingbinding.JComboBoxBinding jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listCidade, cbx_cidade);
        bindingGroup.addBinding(jComboBoxBinding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tbl_funcionario, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.objCidade}"), cbx_cidade, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tbl_funcionario, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.salarioFuncionario}"), jTextField1, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        jLabel4.setText("Sálario:");
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tbl_funcionario, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nascimentoFuncionario}"), txt_nascimento, org.jdesktop.beansbinding.BeanProperty.create("value"));
        bindingGroup.addBinding(binding);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(input_codigo, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextField1)
                            .addComponent(input_cidade, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cbx_cidade, 0, 216, Short.MAX_VALUE)
    ...
    private void btn_ultimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ultimoActionPerformed
        ...
        int linha = tbl_funcionario.getRowCount()-1;
 
        tbl_funcionario.setRowSelectionInterval(linha, linha);
        tbl_funcionario.scrollRectToVisible(tbl_funcionario.getCellRect(linha, 0, true));
    ...
    private void btn_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_excluirActionPerformed
        ...
        if(opcao == 0){
            int linhaSelecionada = tbl_funcionario.getSelectedRow();
            Funcionario objFuncionario = listFuncionario.get(linhaSelecionada);
            objFuncionarioDAO.remover(objFuncionario);
    ...
    private void btn_primeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_primeiroActionPerformed
        // TODO add your handling code here:
        tbl_funcionario.setRowSelectionInterval(0, 0);
        tbl_funcionario.scrollRectToVisible(tbl_funcionario.getCellRect(0, 0, true));
    ...
    private void btn_proximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_proximoActionPerformed
        // TODO add your handling code here:
        int linha = tbl_funcionario.getSelectedRow();
        if((linha +1) <= (tbl_funcionario.getRowCount()-1)){
            linha++;
        }
        tbl_funcionario.setRowSelectionInterval(linha, linha);
        tbl_funcionario.scrollRectToVisible(tbl_funcionario.getCellRect(linha, 0, true));
    ...
    private javax.swing.JComboBox<String> cbx_cidade;
